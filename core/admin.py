...
from .models import Filiere, Niveau, Matiere, Utilisateur, Sujet, Telechargement, Activite, Verification
...
class SujetAdmin(admin.ModelAdmin):
    list_display = ('titre', 'matiere', 'niveau', 'annee_academique', 'statut', 'vues', 'telechargements')
