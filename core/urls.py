...
urlpatterns = [
    ...
    path('mot-de-passe-oublie/', views.password_reset_envoyer, name='password_reset'),
    path('mot-de-passe-oublie/code/', views.password_reset_code, name='password_reset_code'),
    path('mot-de-passe-oublie/nouveau/', views.password_reset_new, name='password_reset_new'),
    # Admin
